...
static bool isBdgConnected;
static bool isDSCEnable;
...
disp_path_handle _display_interface_path_init(disp_lcm_handle *plcm)
{
	...
	isDSCEnable = data_config.dsi_config.bdg_dsc_enable;
	isBdgConnected = bdg_is_bdg_connected();
	if (isBdgConnected) {
