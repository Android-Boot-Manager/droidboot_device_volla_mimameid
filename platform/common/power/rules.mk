...
#prize add by zhaopengge----20210226--start
ifeq ($(MTK_SGM41512_SUPPORT),yes)
	OBJS += $(LOCAL_DIR)/sgm41512.o
	DEFINES += MTK_SGM41512_SUPPORT
	DEFINES += SWCHR_POWER_PATH
endif
#prize add by zhaopengge----20210226--end
...
#prize add by liaoxingen for cw2017 20210823-start
ifeq ($(MTK_CW2017_SUPPORT),yes)
OBJS +=$(LOCAL_DIR)/cw2017_fuel_gauge.o
DEFINES += MTK_CW2017_SUPPORT
endif
ifeq ($(CONFIG_MTK_CW2017_SUPPORT_OF),yes)
DEFINES += CONFIG_MTK_CW2017_SUPPORT_OF
endif
ifeq ($(CONFIG_MTK_CW2017_BATTERY_ID_AUXADC),yes)
DEFINES += CONFIG_MTK_CW2017_BATTERY_ID_AUXADC
endif
#prize add by liaoxingen for cw2017 20210823-start
