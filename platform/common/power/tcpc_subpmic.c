...
#define MT6360_REG_HILO_CTRL3		(0xD7)
#define MT6360_REG_HILO_CTRL4		(0xD8)
#define MT6360_VREF_LODET_SNK_SHIFT	0
#define MT6360_VREF_LODET_SNK_MASK	0x0F
#define MT6360_VREF_LODET_SNK_MINVAL	200
#define MT6360_VREF_LODET_SNK_MAXVAL	3200
#define MT6360_VREF_LODET_SNK_STEP	200
...
#ifdef TYPEC_MT6360
int pd_inc_cc_det_lower_bound(void)
{
	int ret = 0;
	u8 data = (MT6360_VREF_LODET_SNK_MAXVAL - MT6360_VREF_LODET_SNK_MINVAL) /
		   MT6360_VREF_LODET_SNK_STEP;

	ret = subpmic_typec_update_bits(&g_sti, MT6360_REG_HILO_CTRL3,
					MT6360_VREF_LODET_SNK_MASK,
					data << MT6360_VREF_LODET_SNK_SHIFT);
	if (ret < 0)
		return ret;
	return subpmic_typec_update_bits(&g_sti, MT6360_REG_HILO_CTRL4,
					 MT6360_VREF_LODET_SNK_MASK,
					 data << MT6360_VREF_LODET_SNK_SHIFT);
}
#endif /* TYPEC_MT6360 */
