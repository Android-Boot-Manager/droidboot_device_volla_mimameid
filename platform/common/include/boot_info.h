...
struct boot_info {
	...
	uint32_t bootimg_os_version;
	uint32_t bootimg_hdr_version;
	uint32_t bootimg_load_addr;
	uint32_t vendorbootimg_load_addr;
	uint32_t kernel_sz;
