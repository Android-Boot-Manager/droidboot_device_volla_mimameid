...
#include <mt_emi_isu.h>
#include <mt_dramc.h>

typedef struct emi_info {
	unsigned char dram_type;
	unsigned char support_ch_cnt;
	unsigned char ch_cnt;
	unsigned char rk_cnt;
	unsigned short mr_cnt;
	unsigned short freq_cnt;
	unsigned long long rk_size[DRAMC_MAX_RK];
