...
#endif
#ifdef MTK_DPM_SUPPORT
extern unsigned int (* plat_dpm_data_get)(u64 offset, int *len, CALLBACK dev_write);
#endif
#ifdef MTK_GPU_DFD_SUPPORT
extern unsigned int (* plat_gpu_dfd_get)(u64 offset, int *len, CALLBACK dev_write);
#endif

extern unsigned int (* plat_atf_footprint_log_get)(u64 offset, int *len, CALLBACK dev_write);

/* SMC ID for ATF control */
