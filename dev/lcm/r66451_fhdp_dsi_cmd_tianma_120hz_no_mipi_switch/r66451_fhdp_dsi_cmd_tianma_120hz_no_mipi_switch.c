...
#ifndef MACH_FPGA
#if (LCM_DSI_CMD_MODE)
	params->dsi.PLL_CLOCK = 380; /* ori clk = 570M, 1/3 compression */
#else
...
LCM_DRIVER r66451_fhdp_dsi_cmd_tianma_120hz_no_mipi_switch_lcm_drv = {
	.name = "r66451_fhdp_dsi_cmd_tianma_120hz_no_mipi_switch_drv",
