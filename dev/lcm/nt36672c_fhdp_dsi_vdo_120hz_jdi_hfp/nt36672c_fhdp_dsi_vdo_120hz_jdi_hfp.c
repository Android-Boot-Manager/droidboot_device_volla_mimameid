...
#define LCM_ID_NT36672C_JDI (0x41) // TO DO
...
#endif
	params->dsi.vertical_frontporch_for_low_power = 4178;
	params->dsi.vertical_active_line = FRAME_HEIGHT;

	params->dsi.horizontal_sync_active = 12;
	params->dsi.horizontal_backporch = 56;
#if HFP_SUPPORT
	params->dsi.horizontal_frontporch = 983;
#else
	params->dsi.horizontal_frontporch = 274;
#endif
...
LCM_DRIVER nt36672c_fhdp_dsi_vdo_120hz_jdi_hfp_lcm_drv = {
	.name = "nt36672c_fhdp_dsi_vdo_120hz_jdi_hfp_lcm_drv",
