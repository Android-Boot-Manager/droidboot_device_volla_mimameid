...
#define LCM_ID_HX83112F (0x6A) // TO DO
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGI("%s,HX83112F_id=0x%08x,version_id=0x%x\n", __func__, id, version_id);

	if (id == LCM_ID_HX83112F && version_id == 0x00)
		return 1;
	else
		return 0;
...
LCM_DRIVER hx83112f_fhdp_dsi_vdo_cphy_90hz_lcm_drv = {
	.name = "hx83112f_fhdp_dsi_vdo_cphy_90hz_lcm_drv",
