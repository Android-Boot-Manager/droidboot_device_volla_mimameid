...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch_for_low_power = 743;
...
#else
	params->dsi.PLL_CLOCK = 443;	/* this value must be in MTK suggested table */
#endif
#else
...
LCM_DRIVER nt35695B_fhd_dsi_vdo_auo_rt4801_lcm_drv = {
	.name = "nt35695B_fhd_dsi_vdo_auo_rt4801_drv",
