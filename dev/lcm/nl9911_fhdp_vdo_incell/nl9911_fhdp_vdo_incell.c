...
static unsigned int lcm_compare_id(void)
{
	...
	read_reg_v2(0xDC, buffer1, 1);
	id1 = buffer1[0];  
	lcd_id = id1; 
	printf("%s,nl9911_fhdp_dsi_vdo_incell nl9911_id1=0x%x\n", __func__, id1);
	...
	id = (buffer[0] << 8) + buffer[1];     /* we only need ID */
	 if ((id== 0x9911) && (id1 == 0x1 || id1 == 0x2 || id1 == 0x3)) break;
    }
	LCM_LOGI("%s,nl9911_id=0x%x,id0=0x%x,id1=0x%x\n", __func__,id,buffer[0],buffer[1]);
