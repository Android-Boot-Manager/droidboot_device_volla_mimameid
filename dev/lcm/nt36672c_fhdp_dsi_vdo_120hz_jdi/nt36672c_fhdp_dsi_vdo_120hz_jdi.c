...
#define LCM_ID_NT36672C_JDI (0x56) // TO DO
...
#else
	params->dsi.PLL_CLOCK = 588;	/* this value must be in MTK suggested table */
#endif
	params->dsi.data_rate = 1176;
...
LCM_DRIVER nt36672c_fhdp_dsi_vdo_120hz_jdi_lcm_drv = {
	.name = "nt36672c_fhdp_dsi_vdo_120hz_jdi_lcm_drv",
