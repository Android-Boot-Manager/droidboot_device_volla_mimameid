...
int mrdump_null_output(const struct mrdump_control_block *kparams, const struct kzip_addlist *memlist, const struct kzip_addlist *memlist_cmm);
int mrdump_ext4_output(const struct mrdump_control_block *mrdump_cb, const struct kzip_addlist *memlist, const struct kzip_addlist *memlist_cmm, struct mrdump_dev *mrdump_dev);
